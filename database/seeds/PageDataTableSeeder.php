...
class PageDataTableSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      $table->insert([
        ...
        'image_path_1' => '',
        'image_meta_1' => 'Everything is meta here',
        'video_path_1' => '',
        'video_meta_1' => 'What is meta?',
      ...
      $table->insert([
        ...
        'video_path_1' => '',
        'video_meta_1' => 'What is meta?',
        'content_1' => 'Mauris semper lorem sed mauris vestibulum tempor. In hac habitasse platea dictumst. Vestibulum molestie urna eget neque pulvinar, sit amet ultricies velit venenatis. Vivamus dictum condimentum faucibus. Phasellus in nulla neque. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in ullamcorper velit, sit amet hendrerit leo. Phasellus pulvinar mattis odio, sit amet tincidunt risus maximus nec.',
        'content_2' => '',
        'deleted' => 0
      ]);
